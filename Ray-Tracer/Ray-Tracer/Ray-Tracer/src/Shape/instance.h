...
// Classes for translation and Rotation of geometric primitives.
// Are equivalent to trnasformation matrices with the caveat - you don't really alter the objects(on hit) themselves but alter ray directon
